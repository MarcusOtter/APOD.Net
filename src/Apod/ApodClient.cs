...
namespace Apod
{
    ...
    public class ApodClient : IApodClient
    {
        ...
        //    : this(apiKey, DependencyInversionFactory.GetHttpRequester(apiKey), DependencyInversionFactory.GetErrorHandler()) { }
        ...
        //    : this(apiKey, httpRequester, DependencyInversionFactory.GetErrorHandler()) { }
        ...
        //    : this(apiKey, DependencyInversionFactory.GetHttpRequester(apiKey), errorHandler) { }
        ...
        //    _jsonSerializerOptions = DependencyInversionFactory.GetJsonSerializerOptions();
        //}

        ///// <summary>Fetch the current Astronomy Picture of the Day.</summary>
        //public async Task<ApodContent> FetchApodAsync()
        //{
        ...
        //public async Task<ApodContent> FetchApodAsync(DateTime date)
        //{
